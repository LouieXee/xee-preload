    ...
    */
    ...
    _createClass(MyMedia, [{
        ...
        value: function __bindEvents__() {
            ...
            this._events.on('pause', function () {
                _this3.__pause__();
                isWaitToPlay = false;
            });
            ...
            this._events.on('loading', function () {
        ...
        value: function onTimeUpdate(cb) {
            ...
            return function () {
                _this6.$media.off('timeupdate', cb);
            };
        }
    }, {
        key: 'onDone',
